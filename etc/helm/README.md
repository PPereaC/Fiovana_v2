...
```
127.0.0.1 fiovana_v2-local-web
127.0.0.1 fiovana_v2-local-webgateway
127.0.0.1 fiovana_v2-local-authserver
```
...
Now, you can browse the URL: `https://fiovana_v2-local-web`
