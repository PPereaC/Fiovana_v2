...
public class Fiovana_v2EntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<Fiovana_v2DbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also Fiovana_v2DbContextFactory for EF Core tooling. */
