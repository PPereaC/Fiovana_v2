...
namespace Fiovana_v2.Web.Public.Menus;

public class Fiovana_v2PublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public Fiovana_v2PublicMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<Fiovana_v2Resource>();

        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Fiovana_v2PublicMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                Fiovana_v2PublicMenus.ContactUs,
                l["Menu:ContactUs"],
                "~/contact-us",
                icon: "fa fa-phone",
                order: 4
