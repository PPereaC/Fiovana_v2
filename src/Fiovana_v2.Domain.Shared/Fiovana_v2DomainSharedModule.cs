...
public class Fiovana_v2DomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<Fiovana_v2DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<Fiovana_v2Resource>("es")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Fiovana_v2");

            options.DefaultResourceType = typeof(Fiovana_v2Resource);
        ...
        {
            options.MapCodeNamespace("Fiovana_v2", typeof(Fiovana_v2Resource));
        });
    }
}
